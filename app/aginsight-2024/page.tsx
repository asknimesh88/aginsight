...
import { conf2024 as conf, dates2024 as dates, events2024 as events, fmtDate, intro2024 as intro, people, sponsors2024 as sponsors, themes2024 as themes, whyAttend2024 as whyAttend } from "@/lib/site";
...
const seo = {
  path: "/aginsight-2024/",
  title: "AgInsight 2024: 5th International Conference",
  description: "AgInsight 2024, the 5th International Conference of Agricultural Sciences, held 11–12 September 2024 at Sabaragamuwa University of Sri Lanka: speakers, tracks.",
  image: { url: "/og/aginsight.jpg", alt: "AgInsight 2024, 5th International Conference of Agricultural Sciences" },
  keywords: ["AgInsight 2024", "AgInsight", "International Conference of Agricultural Sciences", "agriculture conference Sri Lanka", "Sabaragamuwa University of Sri Lanka", "climate change and food security"],
};
export const metadata = pageMeta(seo);
const schema = graph(webPage({ ...seo, image: seo.image.url, about: EVENT_2024_ID }), breadcrumbs([{ name: "AgInsight 2024", path: seo.path }]), event);
      ...
      <section className="relative isolate overflow-hidden bg-field text-white">
        ...
        <div className="mx-auto max-w-6xl px-4 py-24 sm:py-32">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Button href="/important-dates-2024/">2024 important dates</Button>
            <Button href="/" variant="ghost">See AgInsight 2027</Button>
          </div>
        </div>
      </section>
