...
import { conf2024 as conf, themes2024 as themes } from "@/lib/site";
...
const seo = {
  path: "/call-for-papers-2024/",
  title: "AgInsight 2024 Call for Papers",
  description: "The AgInsight 2024 call for papers: sub-themes in agriculture and agri-environment, agribusiness and agricultural economics, livestock and aquaculture.",
...
const schema = graph(webPage({ ...seo, about: EVENT_2024_ID }), breadcrumbs([{ name: "AgInsight 2024", path: "/aginsight-2024/" }, { name: "Call for Papers", path: seo.path }]), event);
